...
namespace SQLiteUtils
{
    public static class GymAppSQLiteConfig
    {
        ...
        public const string SQLiteRoot = @"D:\rigm\SQLite";
        ...
        public static readonly string DbName = $@"{SQLiteRoot}\Databases\Test.db";                                                      // Database name
        ...
        public static readonly string SqlTempFilePath = Path.Combine(SqlScriptFolder, $@"TempFile.txt");
        #endregion
